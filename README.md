...
5. No hace falta cuenta OpenAI/ChatGPT para usar la pizarra básica.

Despliegue estático self-host: `cd vendor/board && npm ci && BOARD_SELF_HOSTED=true npx vite build --base /dani-ia-tactica/` → servir `vendor/board/dist/`.
