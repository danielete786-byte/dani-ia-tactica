...
export function createDefaultDaniaSession(): DaniaSession {
  return {
    ...
    participants: 20,
    goalkeepers: 2,
    availableGoalkeepers: 'Eric Marín Soto y Tomás Álvarez Rico',
    coachCount: 1,
    absences: 'Adam Navarro Ruiz, José Luis Castro Díez, Jad Benali Torres, Daniel Campos León y Víctor Méndez Calvo.',
...
export function createSalida3421Session(): DaniaSession {
  return {
    ...
    participants: 20,
    goalkeepers: 3,
    availableGoalkeepers: 'Eric Marín Soto, Daniel Campos León y Tomás Álvarez Rico',
    coachCount: 1,
